...
class Pick(QMainWindow):
    ...
    def initUI(self):
        '''Initializes the UI for the user'''

        # Establish the PyQt5-QWidget Pages That Appear at Top of Screen
        ...
        # Define the Stackable QWidget Pages Users Can Navigate Through
        ...
        # SYSTEM BUILDS 'TEAM CONFIGURATION' PAGE GUI
        ...
        team_configuration_lead_ip_address_label_label = QLabel(
            'Lead IP Address')
        # 255.255.255.255 is an example, this needs to be changed later
        team_configuration_lead_ip_address_address_label = QLabel(
            '255.255.255.255')
        team_configuration_no_of_connections_label_label = QLabel(
            'NO. of established connections to the lead\' IP address')
        ...
        team_configuration_layout.addWidget(
            team_configuration_title_label, 0, 0)
        team_configuration_layout.addWidget(
            team_configuration_lead_checkbox, 1, 0)
        team_configuration_layout.addWidget(
            team_configuration_lead_ip_address_label_label, 2, 0)
        team_configuration_layout.addWidget(
            team_configuration_lead_ip_address_address_label, 2, 1)
        team_configuration_layout.addWidget(
            team_configuration_no_of_connections_label_label, 3, 0)
        team_configuration_layout.addWidget(
            team_configuration_no_of_connections_label, 3, 1)
        team_configuration_layout.addWidget(
            team_configuration_connect_button, 4, 3)
        team_configuration_page_widget.setLayout(team_configuration_layout)

        # SYSTEM BUILDS 'EVENT CONFIGURATION' PAGE GUI
        event_configuration_layout = QGridLayout()
        event_configuration_title_label = QLabel(
        ...
        event_configuration_layout.addWidget(
            event_configuration_event_description)
        event_configuration_layout.addWidget(
            event_configuration_event_start_timestamp)
        event_configuration_layout.addWidget(
            event_configuration_event_end_timestamp)
        ...
        directory_configuration_title_label = QLabel(
        ...
        directory_configuration_start_data_ingestion_button.setText(
            'Start Data Ingestion')

        directory_configuration_layout.addWidget(
            directory_configuration_title_label)
        directory_configuration_layout.addWidget(
            directory_configuration_root_directory)
        directory_configuration_layout.addWidget(
            directory_configuration_red_folder)
        directory_configuration_layout.addWidget(
            directory_configuration_blue_folder)
        directory_configuration_layout.addWidget(
            directory_configuration_white_folder)
        directory_configuration_layout.addWidget(
            directory_configuration_start_data_ingestion_button)

        directory_configuration_page_widget.setLayout(
            directory_configuration_layout)

        # SYSTEM BUILDS 'VECTOR CONFIGURATION' PAGE GUI
        vector_configuration_layout = QGridLayout()
        vector_configuration_title_label = QLabel(
        ...
        vector_configuration_table.setHorizontalHeaderLabels(
        ...
        vector_configuration_layout.addWidget(
            vector_configuration_delete_button)
        ...
        log_file_configuration_title_label = QLabel(
            '<h1>Log File Configuration<\h1>')
        ...
        log_file_configuration_log_file_table.setHorizontalHeaderLabels(
        ...
        log_file_configuration_action_report_table.setHorizontalHeaderLabels(
        ...
        log_file_configuration_layout.addWidget(
            log_file_configuration_title_label)
        log_file_configuration_layout.addWidget(
            log_file_configuration_log_file_table)
        log_file_configuration_layout.addWidget(
            log_file_configuration_action_report_table)

        log_file_configuration_page_widget.setLayout(
            log_file_configuration_layout)

        # makes filter config page widget
        filter_configuration_layout = QGridLayout()
        filter_configuration_title_label = QLabel(
        ...
        filter_configuration_layout.addWidget(
            filter_configuration_keyword_search_textbox)
        filter_configuration_layout.addWidget(
            filter_configuration_creator_label)
        filter_configuration_layout.addWidget(
            filter_configuration_red_checkbox)
        filter_configuration_layout.addWidget(
            filter_configuration_blue_checkbox)
        filter_configuration_layout.addWidget(
            filter_configuration_white_checkbox)
        filter_configuration_layout.addWidget(
            filter_configuration_start_timestamp)
        filter_configuration_layout.addWidget(
            filter_configuration_end_timestamp)
        ...
        log_entry_configuration_title_label = QLabel(
            '<h1>Log Entry Configuration<\h1>')
        ...
        log_entry_configuration_table.setHorizontalHeaderLabels(
            ['', 'List Number', 'Log Entry Timestamp', 'Log Entry Event', 'Vector'])

        log_entry_configuration_layout.addWidget(
            log_entry_configuration_title_label)
        log_entry_configuration_layout.addWidget(log_entry_configuration_table)

        log_entry_configuration_page_widget.setLayout(
            log_entry_configuration_layout)
        ...
        export_configuration_layout.addWidget(
            export_configuration_dropdown_menu)
        export_configuration_layout.addWidget(
            export_configuration_export_button)
        ...
        change_configuration_change_list_label = QLabel(
            'Change List: ')
        ...
        change_configuration_layout.addWidget(
            change_configuration_change_list_label)
        change_configuration_layout.addWidget(change_configuration_undo_button)
        change_configuration_layout.addWidget(
            change_configuration_commit_button)
        ...
        vector_db_configuration_connection_label = QLabel(
            'Connection status to lead: ')
        # 4 is just and example, this needs to be changed later
        vector_db_configuration_actual_connection_number = QLabel('4')
        vector_db_configuration_pulled_vector_table = QLabel(
        ...
        vector_db_configuration_pushed_vector_label = QLabel(
        ...
        vector_db_configuration_layout.addWidget(
            vector_db_configuration_connection_label)
        vector_db_configuration_layout.addWidget(
            vector_db_configuration_actual_connection_number)
        vector_db_configuration_layout.addWidget(
            vector_db_configuration_pulled_table)
        vector_db_configuration_layout.addWidget(
            vector_db_configuration_pull_button)
        vector_db_configuration_layout.addWidget(
            vector_db_configuration_pushed_vector_label)
        vector_db_configuration_layout.addWidget(
            vector_db_configuration_pushed_table)
        vector_db_configuration_layout.addWidget(
            vector_db_configuration_push_button)

        vector_db_configuration_page_widget.setLayout(
            vector_db_configuration_layout)
        ...
        icon_configuration_table.setHorizontalHeaderLabels(
        ...
        icon_configuration_layout.addWidget(
            icon_configuration_delete_icon_button)
        icon_configuration_layout.addWidget(
            icon_configuration_edit_icon_button)
        ...
        graph_builder_configuration_vector_dropdown_menu.addItem(
            'example vector 1')
        graph_builder_configuration_vector_dropdown_menu.addItem(
            'example vector 2')
        graph_builder_configuration_description_label_label = QLabel(
            'Description')
        graph_builder_configuration_description_label = QLineEdit()
        graph_builder_configuration_description_label.setText(
            'Example description')
        ...
        graph_builder_configuration_add_relationship_button.setText(
            'Add Relationship')
        ...
        graph_builder_configuration_delete_relationship_button.setText(
            'Delete Relationship')
        ...
        graph_builder_configuration_edit_relationship_button.setText(
            'Edit Relationship')

        graph_builder_configuration_layout.addWidget(
            graph_builder_configuration_vector_label)
        graph_builder_configuration_layout.addWidget(
            graph_builder_configuration_vector_dropdown_menu)
        graph_builder_configuration_layout.addWidget(
            graph_builder_configuration_description_label_label)
        graph_builder_configuration_layout.addWidget(
            graph_builder_configuration_description_label)
        graph_builder_configuration_layout.addWidget(
            graph_builder_configuration_add_node_button)
        graph_builder_configuration_layout.addWidget(
            graph_builder_configuration_add_relationship_button)
        graph_builder_configuration_layout.addWidget(
            graph_builder_configuration_delete_node_button)
        graph_builder_configuration_layout.addWidget(
            graph_builder_configuration_delete_relationship_button)
        graph_builder_configuration_layout.addWidget(
            graph_builder_configuration_edit_node_button)
        graph_builder_configuration_layout.addWidget(
            graph_builder_configuration_edit_relationship_button)

        graph_builder_configuration_page_widget.setLayout(
            graph_builder_configuration_layout)

        # makes nodes config table page widget
        nodes_tabular_configuration_layout = QGridLayout()
        nodes_tabular_configuration_title_label = QLabel(
        ...
        nodes_tabular_configuration_table.setHorizontalHeaderLabels(
            ['Node Property Visibility', 'Node ID', 'Node Name', 'Node Timestamp', 'Node Description', 'Log Entry Reference', 'Log Creator', 'Event Type', 'Icon Type', 'Source', 'Node Visibility'])
        nodes_tabular_configuration_layout.addWidget(
            nodes_tabular_configuration_title_label)
        nodes_tabular_configuration_layout.addWidget(
            nodes_tabular_configuration_table)
        nodes_tabular_configuration_page_widget.setLayout(
            nodes_tabular_configuration_layout)

        # makes nodes config graph page widget
        nodes_graphical_configuration_layout = QGridLayout()
        nodes_graphical_configuration_title_label = QLabel(
            'Nodes Configuration in Graphical Format')
        nodes_graphical_configuration_timeline_orientation_label = QLabel(
            'Timeline Orientation')
        nodes_graphical_configuration_timeline_orientation_dropdown = QComboBox()
        nodes_graphical_configuration_timeline_orientation_dropdown.addItem(
            'example orientation')
        nodes_graphical_configuration_interval_units_label = QLabel(
            'Interval Units')
        nodes_graphical_configuration_interval_units_dropdown = QComboBox()
        nodes_graphical_configuration_interval_units_dropdown.addItem(
            'example interval unit')
        nodes_graphical_configuration_timeline = QLabel(
            'A TIMELINE IS SUPPOSED TO GO HERE')
        ...
        nodes_graphical_configuration_layout.addWidget(
            nodes_graphical_configuration_title_label)
        nodes_graphical_configuration_layout.addWidget(
            nodes_graphical_configuration_timeline_orientation_label)
        nodes_graphical_configuration_layout.addWidget(
            nodes_graphical_configuration_timeline_orientation_dropdown)
        nodes_graphical_configuration_layout.addWidget(
            nodes_graphical_configuration_interval_units_label)
        nodes_graphical_configuration_layout.addWidget(
            nodes_graphical_configuration_interval_units_dropdown)
        nodes_graphical_configuration_layout.addWidget(
            nodes_graphical_configuration_timeline)
        nodes_graphical_configuration_layout.addWidget(
            nodes_graphical_configuration_zoom_in_button)
        nodes_graphical_configuration_layout.addWidget(
            nodes_graphical_configuration_zoom_out_button)

        nodes_graphical_configuration_page_widget.setLayout(
            nodes_graphical_configuration_layout)

        # makes relationships config page widget
        relationship_config_layout = QGridLayout()
        relationship_config_title_label = QLabel(
        ...
        relationship_configuration_page_widget.setLayout(
            relationship_config_layout)
        ...
        team_configuration_connect_button.clicked.connect(
            self.team_configuration_connect_button_clicked)
